  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        verification: "hsl(var(--verification))",
        ...
        "status-initialized": "hsl(var(--status-initialized))",
        "status-running": "hsl(var(--status-running))",
        "status-evaluating": "hsl(var(--status-evaluating))",
        "status-remediation": "hsl(var(--status-remediation))",
        "status-paused": "hsl(var(--status-paused))",
        "status-completed": "hsl(var(--status-completed))",
        "status-stopped": "hsl(var(--status-stopped))",
        sidebar: {
